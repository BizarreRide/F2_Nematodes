...
df.response1 <- round(fam.usc[,c("Tylenchidae", "Aphelenchidae", "Panagrolaimidae", "Cephalobidae", "Plectidae", "Telotylenchidae", "Aphelenchoididae", "Rhabditidae", "Aporcelaimidae",  "Panagrolaimidae")],0)
